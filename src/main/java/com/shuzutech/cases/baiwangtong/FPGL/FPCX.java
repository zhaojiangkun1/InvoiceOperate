...
public class FPCX {
    ...
    private static String fpqqlsh = "SZZPY20210715161406";
    private static String fpdm = "050000000004";
    private static String fphm = "20191671";
