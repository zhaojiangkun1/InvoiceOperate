package com.shuzutech.cases.fpsl;
...
public class FPPLCX {
    ...
    private static String pagesize ="3";
    ...
    public static String body(){
        String body = "<?xml version=\"1.0\" encoding=\"utf-8\"?><business id=\"FPPLCX\"><body><input><nsrsbh>"+nsrsbh+"</nsrsbh><start_date>"+start_date+"</start_date><end_date>"+end_date+"</end_date><page>"+page+"</page><pagesize>"+pagesize+"</pagesize></input></body></business>";
        return body;
    }
}
